        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <header className="space-y-4">
            <h2 className="text-2xl font-light tracking-widest text-white uppercase flex items-baseline">
              AND_Transform <span className="text-[10px] text-zinc-500 font-mono align-top ml-3 tracking-widest font-bold">LOSSY OPERATION</span>
            </h2>
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest max-w-2xl leading-relaxed">
              The AND gate destroys information. If the output is "0", we don't know whether A was 0, B was 0, or both were 0. Reversing this operation yields multiple possibilities and cannot be done deterministically.
            </p>
          </header>
            ...
            <div className="relative z-10 space-y-8">
                ...
                <div className="space-y-4 relative">
                  <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-4">
                    ...
                    <input 
                      ...
                      className="w-full bg-transparent border-none font-mono text-sm text-pink-400 tracking-[0.5em] focus:outline-none focus:ring-0 p-0"
                      maxLength={8}
                    />
                  </div>
                  <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-4">
                        ...
                        <div className="flex items-start space-x-3 text-red-500">
                          ...
                          <div>
                            ...
                            <p className="text-[10px] font-mono mt-1 opacity-80 leading-relaxed uppercase">
                              Entropy was lost. Exact reconstruction is mathematically impossible because multiple inputs map to 0.
                            </p>
                          </div>
                        </div>
                      </motion.div>
              ...
              <div className="pt-6 border-t border-zinc-800 flex items-center justify-between">
                 <div className="space-y-1">
                  ...
                  <p className="text-[9px] text-zinc-600 uppercase tracking-widest font-mono">Operations that map multiple states to one cannot be inverted.</p>
                </div>
